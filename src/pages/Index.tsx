      ...
      <section className="py-16 sm:py-24 px-4 sm:px-8" style={{ backgroundColor: '#F0F5FF' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-4 mb-6 sm:mb-8">
            <div className="flex flex-col items-center text-center gap-4 bg-white rounded-2xl px-8 sm:px-12 py-6 border border-[#1B3461]/10 shadow-sm mx-auto w-fit max-w-[90%]">
